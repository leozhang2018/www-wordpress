	...
	<div class="center case-details-content">
        ...
        <div class="case-details">
            ...
            <div class="case-details-main">
                ...
                <p>由于七牛采用的分布式存储架构本身具有很强的可扩展性，平均色算法程序交给七牛之后，七牛技术人员用一周时间就将 Daemon 做出来了，后面用了不到一周时间来做调试和优化。总共花费两周不到的时间，这项服务就正式上线了，为 Camera360 和其他需要此项服务的七牛小伙伴均带来了很大方便，在图片上传后调用之前，就完成了平均色的计算和填充，极大地改善了用户体验。</p>
            </div>
        </div>
	</div>
